...
paddingh = 5
paddingv = 5
log_file = home_path + 'logs/tea-2' + datetime.now().strftime('%y-%m-%d') + '.log'
...
prompt = tk.Label(root, text='Enter word with misprint: ', font=(text_font, text_size), bg=bgcolour[theme],
                  fg=fgcolour[theme])
